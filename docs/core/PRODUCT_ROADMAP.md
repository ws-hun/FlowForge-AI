...
- Active execution identity remains visible across navigation: the global shell and AI Command distinguish direct tasks, Flow runs, historical reruns, and recoveries, and the shell status links back to the immutable execution source.
