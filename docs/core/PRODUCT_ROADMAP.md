...
- Historical Flow Run snapshots explain how the current Flow has changed since execution across goals, node content, membership, and order without altering the immutable result.
